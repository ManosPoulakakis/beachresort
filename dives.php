...
<head>
	<meta charset="UTF-8">
	<title>Dive Sites - Santo Beach Resort</title>
...
<body>
	<div id="background">
		<div id="page">
			<div id="header">
				...
				<nav id="nav-3">
				  ...
				  <a class="link-3" href="gallery.php">Gallery</a>
				  <a class="link-3" href="contact.php">Contact</a>
				  <a class="link-3" href="rooms.php">Booking</a>
				  <a class="link-3" href="news.php"> Announcements</a>
				...
				<div class="box">
					<div>
						<div class="body">
							...
							<ul id="sites">
								<li>
									<a href="dives.php"><img src="images/reef1.jpg" alt="Img"></a>
									<h2><a href="dives.php">Gale Reef</a></h2>
									<p>
		...
		<div id="footer">
			...
			<p>
				© 2019 by SANTO BEACH RESORT. All Rights Reserved
			</p>
		</div>
	</div>
</body>
